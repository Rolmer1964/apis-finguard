...
class Settings(BaseSettings):
    ...
    # Modelo de avaliação de risco. Sonnet: raciocínio mais elaborado, cita
    # seções da política e monta a lista de ações imediatas.
    ...
    # esta chave (usa o mesmo BEDROCK_MODEL_RISK, convertido para o id
