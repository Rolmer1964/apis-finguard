...
Portado de `finguard8/app/src/llm.py` (via `fin_triage`). Diferença:
`invoke_claude` recebe o client já criado (por `app/_bedrock.py`) em vez de
criá-lo internamente.
"""
...
def bedrock_to_anthropic_model_id(model_id: str) -> str:
    """Converte um model id do Bedrock (ex. 'us.anthropic.claude-sonnet-4-5-20250929-v1:0')
    para o id nativo da Anthropic API (ex. 'claude-sonnet-4-5-20250929')."""
